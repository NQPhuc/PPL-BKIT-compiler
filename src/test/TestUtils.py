...
class TestCodeGen():
    ...
    def test(input, expect, num):
        ...
        try:
            ...
            #os.pathsep = ";" // just a separator for a list of paths to search for class file
            #MCClass is the main class for our java program
        ...
        print("\n==============================BEGIN", num, "================================")#remove this when done
        print("Input: " + str(asttree) + "<EOF> || num: ", num, " | ", line == expect)#remove this when done
        print("--Jasmin Code ", num, " --")#remove this when done
        print(open(path + "/MCClass.j", "r").read())#remove this when done
        #print("--Decompiled Java Byte Code ", num, " --", flush = True)#remove this when done
        #remove when done
        #subprocess.call("\"C:\\Program Files\\Java\\jdk-15\\bin\\javap.exe\" -v MCClass.class",shell=True,stderr=subprocess.STDOUT)
        print("Result: " + line)#remove this when done
        print("Expect: " + expect)#remove this when done
        print("================================END", num, "================================\n", flush=True)#remove this when done
