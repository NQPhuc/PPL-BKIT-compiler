...
class Frame():
    ...
    *   simulate an instruction that pushes a value onto operand stack.
    '''
    def push(self):
        #print("push <" + self.name + ">: ", self.currOpStackSize, " -> ", self.currOpStackSize + 1) #remove when done
    ...
    *   simulate an instruction that pops a value out of operand stack.
    '''
    def pop(self):
        #print("pop <" + self.name + ">: ", self.currOpStackSize, " -> ", self.currOpStackSize - 1) #remove when done
        self.currOpStackSize = self.currOpStackSize - 1
